...
public:
	...
	*/
	...
	std::vector<uint64_t> FindSignatures(const char* signature, uint64_t range_start, uint64_t range_end, size_t max_results = 2);
	...
	*/
	...
	bool WriteString(uintptr_t address, const std::string& value) const;
